						...
						<div id="DataTables_Table_0_wrapper" class="dataTables_wrapper"
							...
							<div id="DataTables_Table_0_length" class="dataTables_length">
								<label> 省名称
									...
									(区域代码参考网址<a href="javasript:void()" ng-click="open()">http://www.ip33.com/area_code.html</a>) 
								</label>
							</div>
				...
				<div class="module-body">
					...
					<form class="form-horizontal row-fluid">
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" ng-model="itemCode" placeholder="请填写区域代码"
									class="span8 tip">
							</div>
						</div>
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" ng-model="itemName" placeholder="请填写区域名称"
									class="span8 tip">
							</div>
						</div>
						<div class="control-group">
		...
		<script type="text/javascript">
			...
			app.controller('myCtrl', function($scope,$http) {
			    ...
			    $scope.addItemSub = function() {
			    	if($scope.itemName == ''){
			    		$scope.addError = true;
			    		$scope.errTxt = '区域名称不能为空';
			    		return;
			    	}
			    	
			    	if($scope.itemCode == ''){
			    		$scope.addError = true;
			    		$scope.errTxt = '区域代码不能为空';
			    		return;
			    	}
		    		...
		    		if($scope.itemId==''){
					    ...
					    $http({
					        ...
					        params: {
					        	name:itemName,code:itemCode,pname:itemName,level:1
							}
					    }).then(function mySucces(response) {
					    	$scope.loadingShow = false;
					    ...
					    $http({
					        ...
					        params: {
					        	id:id,name:itemName,code:itemCode,pname:itemName,oldCode:oldCode,level:1
							}
					    }).then(function mySucces(response) {
					    	$scope.loadingShow = false;
					        if(response.data.code==0){
			    ...
			    $scope.showCity = function(item) {
			    	...
			    	window.parent.contentIframe.src = "<%=basePath%>area/toCityList.do?pcode="+pcode+"&pname="+pname;
			    };
			    //区域代码参考
			    $scope.open = function() {
				   window.open("http://www.ip33.com/area_code.html");
			    };
			});
		</script>
	</body>
