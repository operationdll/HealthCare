				...
				<div class="module-body">
					...
					<form class="form-horizontal row-fluid">
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" ng-model="itemCode" placeholder="请填写区\县代码"
									class="span8 tip">
							</div>
						</div>
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" ng-model="itemName" placeholder="请填写区\县名称"
									class="span8 tip">
							</div>
						</div>
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" ng-model="itemHcode" placeholder="请填写省接口区县代码"
		...
		<script type="text/javascript">
			...
			function initListData($http,$scope){
			    ...
			    $http({
				    ...
				    params: {name:sName,level:3,pcode:pcode}
			...
			app.controller('myCtrl', function($scope,$http) {
			    ...
			    $scope.addItemSub = function() {
			    	if($scope.itemName == ''){
			    		$scope.addError = true;
			    		$scope.errTxt = '区\县名称不能为空';
			    		return;
			    	}
			    	
			    	if($scope.itemCode == ''){
			    		$scope.addError = true;
			    		$scope.errTxt = '区\县代码不能为空';
			    		return;
			    	}
			    	...
			    	if(itemCode.indexOf($("#pcode").val())!=0){
			    		$scope.addError = true;
			    		$scope.errTxt = "区\县代码必须以"+pcode+"开头";
			    		return;
			    	}
		    		...
		    		if($scope.itemId==''){
					    ...
					    $http({
					        ...
					        params: {
					        	name:itemName,code:itemCode,pname:pName,level:3,pcode:pcode,hcode:itemHcode
							}
					    }).then(function mySucces(response) {
					    	$scope.loadingShow = false;
					    ...
					    $http({
					        ...
					        params: {
					        	id:id,name:itemName,code:itemCode,pname:pName,level:3,pcode:pcode,hcode:itemHcode,
					        	oldCode:oldCode
							}
					    }).then(function mySucces(response) {
					    	$scope.loadingShow = false;
