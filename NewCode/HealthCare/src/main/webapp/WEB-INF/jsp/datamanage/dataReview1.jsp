		...
		<script type="text/javascript">
			...
			function initListData(v,filed,$http,$scope){
				$(function(){
				    ...
				    $http({
				        method : "GET",
				        url : "<%=basePath%>DMG/getDataReview1.do",
				        params: {idCard:idCard,name:name,code:code,startDate:startDate,endDate:endDate,selAge:selAge,order:v,filed:filed,hcid:hcid}
