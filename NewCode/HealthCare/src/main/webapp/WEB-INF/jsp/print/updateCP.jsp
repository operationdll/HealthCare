	...
	<body ng-app="myApp" ng-controller="myCtrl">
		...
		<table width="100%" height="100%" border="0">
			...
			<tr height="30px">
				...
				<td align="left">
					<input type="text" id="field14" style="width:200px;" value="${healthCheck.field14}"/>
				</td>
			</tr>
			<tr height="30px">
				<td align="center">
				...
				<td align="left">
					<input type="text" id="field247" style="width:200px;" value="${healthCheck.field247}"/>
				</td>
			</tr>
			<tr height="30px">
				<td align="center">
				...
				<td align="left">
					<input type="text" id="field248" style="width:200px;" value="${healthCheck.field248}"/>
				</td>
			</tr>
			<tr height="30px">
				<td align="center">
				...
				<td align="left">
					<input type="text" id="field249" style="width:200px;" value="${healthCheck.field249}"/>
				</td>
			</tr>
			<tr height="30px">
				<td align="center">
				...
				<td align="left">
					<input type="text" id="field250" style="width:200px;" value="${healthCheck.field250}"/>
				</td>
			</tr>
			<tr height="30px">
				<td align="center">
				...
				<td align="left">
					<input type="text" id="fileuser" style="width:200px;" value="${patient.fileuser}"/>
				</td>
			</tr>
			<tr height="30px">
				<td align="center">
				...
				<td align="left">
					<input type="text" id="doctor" style="width:200px;" value="${patient.doctor}"/>
				</td>
			</tr>
			<tr height="30px">
		...
		<lable id="checkDate" style="display:none"><fmt:formatDate pattern="yyyy-MM-dd" value="${healthCheck.field1}"/></lable>
		...
		<script type="text/javascript">
			...
			app.controller('myCtrl', function($scope,$http) {
			    ...
			    $scope.save = function() {
					...
					//拼装参数
					let healthCheckDto = {pid:pid,field14:field14,field247:field247,
								field248:field248,field249:field249,field250:field250,
								field1Str:field1,fileuser:fileuser,doctor:doctor
						};
				    $http({
				        method : "POST",
				        url : "<%=basePath%>print/updCP.do",
